...
class OrdersTest extends TestCase
{
    ...
    public function test_example1(): void
    {
        ...
        $this->post('order/choose-product', ['code' => 'SODA'])
            ->assertStatus(200)
            ->assertJson([
                'success' => true,
                'data' => [
        ...
        $this->assertDatabaseHas('coins', ['value' => 100, 'stock' => 25, 'earned' => 1]);
        $this->assertDatabaseHas('coins', ['value' => 25, 'stock' => 15, 'earned' => 2]);
        $this->assertDatabaseHas('coins', ['value' => 10, 'stock' => 50, 'earned' => 0]);
        $this->assertDatabaseHas('coins', ['value' => 5, 'stock' => 100, 'earned' => 0]);
    }
    ...
    public function test_example2(): void
    {
        ...
        $this->post('order/insert-coin', ['value' => 0.1])->assertStatus(200);
        $this->post('order/insert-coin', ['value' => 0.1])->assertStatus(200);
        ...
        $this->assertDatabaseHas('coins', ['value' => 100, 'stock' => 25, 'earned' => 0]);
        $this->assertDatabaseHas('coins', ['value' => 25, 'stock' => 15, 'earned' => 0]);
        $this->assertDatabaseHas('coins', ['value' => 10, 'stock' => 50, 'earned' => 0]);
        $this->assertDatabaseHas('coins', ['value' => 5, 'stock' => 100, 'earned' => 0]);
    }
    ...
    public function test_example3(): void
    {
        ...
        $this->post('order/choose-product', ['code' => 'WATER'])
            ->assertStatus(200)
            ->assertJson([
                'success' => true,
                'data' => [
        ...
        $this->assertDatabaseHas('coins', ['value' => 100, 'stock' => 25, 'earned' => 1]);
        $this->assertDatabaseHas('coins', ['value' => 25, 'stock' => 14, 'earned' => 0]);
        $this->assertDatabaseHas('coins', ['value' => 10, 'stock' => 49, 'earned' => 0]);
        $this->assertDatabaseHas('coins', ['value' => 5, 'stock' => 100, 'earned' => 0]);
    }
    ...
    public function test_invalidInputs(): void
    {
        ...
        $this->post('order/choose-product', ['code' => 'LEMONADE'])
            ->assertStatus(404)
            ->assertJson([
                'success' => false,
